...
def process(filename):
    ...
    with open(filename, "r") as input_file:
        ...
        for player in players:
            ...
            if players[player]['batting_bonus'] == '50 run bonus':
                players[player]['fantasy_points'] += 4
            elif players[player]['batting_bonus'] == '100 run bonus':
                players[player]['fantasy_points'] += 8
            if players[player]['duck'] == 'Yes':
                players[player]['fantasy_points'] -= 3

            if players[player]['balls_faced'] > 20:
                if players[player]['strike_rate'] >140:
                    players[player]['fantasy_points'] += 6
                elif players[player]['strike_rate'] > 120:
                    players[player]['fantasy_points'] += 4
                elif players[player]['strike_rate'] > 100:
                    players[player]['fantasy_points'] += 2
                elif players[player]['strike_rate'] < 30:
                    players[player]['fantasy_points'] -= 6
                elif players[player]['strike_rate'] < 40:
                    players[player]['fantasy_points'] -= 4
            ...
            players[player]['fantasy_points'] += players[player]['maiden_over'] * 4
            
            if players[player]['overs_bowled'] >= 5:
                if players[player]['economy_rate'] < 2.5:
                    players[player]['fantasy_points'] += 6
                elif players[player]['economy_rate'] < 3.5:
                    players[player]['fantasy_points'] += 4
                elif players[player]['economy_rate'] < 4.5:
                    players[player]['fantasy_points'] += 2
                elif players[player]['economy_rate'] > 9:
                    players[player]['fantasy_points'] -= 6
                elif players[player]['economy_rate'] > 8:
                    players[player]['fantasy_points'] -= 4
...
if __name__ == '__main__':
    folder_path = '/Users/abhijitraj/Downloads/odis_male_json'
    dfs = []
